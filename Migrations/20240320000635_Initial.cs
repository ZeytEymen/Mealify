    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantUsers", x => new { x.RestaurantId, x.ApplicationUserId });
                    table.ForeignKey(
                        name: "FK_RestaurantUsers_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodMenus", x => new { x.MenuId, x.ContentId });
                    table.ForeignKey(
                        name: "FK_FoodMenus_Foods_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Foods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FoodMenus_Foods_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Foods",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantUsers_ApplicationUserId",
